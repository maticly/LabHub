...
ADD CONSTRAINT fk_user_role FOREIGN KEY(UserRoleID)
REFERENCES core.UserRole(UserRoleID);
...
ALTER TABLE core.Product
ADD CONSTRAINT fk_product_category FOREIGN KEY(ProductCategoryID)
REFERENCES core.ProductCategory(CategoryID);
...
ALTER TABLE supply.[Order]
ADD CONSTRAINT fk_order_vendor FOREIGN KEY(VendorID)
REFERENCES core.Vendor(VendorID);
...
REFERENCES inventory.InventoryItem(InventoryItemID);
...
ADD CONSTRAINT fk_link_supplyrequest FOREIGN KEY(SupplyRequestID)
REFERENCES supply.SupplyRequest(SupplyRequestID);
